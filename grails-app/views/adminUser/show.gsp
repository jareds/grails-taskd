...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <f:display bean="adminUser" />
            <g:form resource="${this.adminUser}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.adminUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
